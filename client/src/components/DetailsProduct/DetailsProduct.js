        ...
        {modal ? (
          <div className="modal">
            <div className="modalContent">
              ...
              <button id="modalDel" onClick={deleteHandler}>
                Delete
              </button>
              <button id="modalCancel" onClick={() => setModal(false)}>
                Cancel
              </button>
            </div>
          </div>
...
export default connect(mapStateToProps, { addCart, deleteProduct })(
  DetailsProduct
);
